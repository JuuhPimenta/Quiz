...
<div class="card border">
    <div class="card-body">
        ...
        <div class="form-group py-4">
            <label for="pergunta"> <h3> <strong> Qual o país(es) que se sediou a copa do Mundo de 2023? </strong> </h3> </label>
